...
```bash
## Spin up the Vagrantfile.
vagrant up

## Select a public bridge with IPv6 enabled.
## WIFI won't work here, nor will VPN in at least my case (AnyConnect).
...
## Watch the provisioning of the vagrant host.
journalctl -f
